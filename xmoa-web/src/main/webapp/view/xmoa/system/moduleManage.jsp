        ...
        <section class="content">
                        ...
                        <div class="box-tools">
                            <div class="input-group" style="width: 350px;margin: 10px 15px;">
                                <input type="text" name="table_search" class="form-control"
                                       placeholder="搜索关键字" style="z-index: 3;" id="moduleQuery">
                                <div class="input-group-btn">
                                    <button type="button" class="btn  bg-teal" onclick="moduleManage.queryModule()"><i class="fa fa-search"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-sm-3">
                        ...
                        <div id="moduleTree4module" class="treeview" style="height:557px ;position: relative">
                        </div>
                    ...
                    <div class="box" style="border-top: 3px solid #428BCA;margin-bottom: 0px">
                        ...
                        <div class="box-body">
                            <div class="tab-container" style="min-height: 431px">
                                <table id="moduleTable" class="table table-bordered table-hover table-striped">
                                    <thead>
                                    <tr>
                            ...
                            <div class="row" style="margin-top: 10px">
                                <div class="col-sm-5">
                                    <div class="dataTables_info" id="module_paginator_info">

                                    </div>
                                </div>
                                <div class="col-sm-7">
                                    <div class="dataTables_paginate" id="module_paginator" style="text-align: right">
...
<!-- 本页面管理js -->
<script type="text/javascript" src="${root}/scripts/xmoa/system/module/moduleManage.js"></script>
</body>
</html>
