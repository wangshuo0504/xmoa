        ...
        <section class="content">
                        ...
                        <div class="box-tools">
                            <div class="input-group" style="width: 350px;margin: 10px 15px;">
                                <input type="text" name="table_search" class="form-control"
                                       placeholder="搜索关键字" style="z-index: 3;" id="actionRightQuery">
                                <div class="input-group-btn">
                                    <button type="button" class="btn  bg-teal" onclick="actionRightManage.queryActionRight()"><i class="fa fa-search"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-sm-3">
                    ...
                    <div id="moduleTree4actionRight" class="treeview" style="height:557px ;position: relative">
                    </div>
                    ...
                    <div class="box" style="border-top: 3px solid #428BCA;margin-bottom: 0px">
                        <div class="box-header" style="padding-bottom: 0px">
                            <div class="columns columns-left btn-group pull-left tool-button-box">
                                ...
                                <button class="btn btn-default" type="button" name="give" title="批量授权角色">
                                    <i class="fa fa-link">&nbsp;批量授权角色</i>
                                </button>
                        ...
                        <div class="box-body">
                            <div class="tab-container" style="min-height: 431px">
                                <table id="actionRightTable" class="table table-bordered table-hover table-striped">
                                    <thead>
                                    <tr>
                                        <th><input type="checkbox" id="checkAll"/></th>
                                        <th width="25%">动作权限名称</th>
                                        <th>动作权限编码</th>
                                        <th>所属资源节点</th>
                                        <th >权限描述</th>
                                    </tr>
                            ...
                            <div class="row" style="margin-top: 10px">
                                <div class="col-sm-5">
                                    <div class="dataTables_info" id="actionRight_paginator_info">

                                    </div>
                                </div>
                                <div class="col-sm-7">
                                    <div class="dataTables_paginate" id="actionRight_paginator" style="text-align: right">
...
<!-- 本页面管理js -->
<script type="text/javascript" src="${root}/scripts/xmoa/system/actionRight/actionRightManage.js"></script>
</body>
</html>
