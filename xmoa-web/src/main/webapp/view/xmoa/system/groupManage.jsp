                        ...
                        <div class="box-tools">
                            <div class="input-group" style="width: 350px;margin: 10px 15px;">
                                <input type="text" name="table_search" class="form-control"
                                       placeholder="搜索关键字" style="z-index: 3;" id="groupQuery">
                                <div class="input-group-btn">
                                    <button type="button" class="btn  bg-teal" onclick="groupManage.queryGroup()"><i class="fa fa-search"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box" style="border-top: 3px solid #428BCA;margin-bottom: 0px">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row" style="margin-top: 10px">
                                <div class="col-sm-5">
                                    <div class="dataTables_info" id="group_paginator_info">

                                    </div>
                                </div>
                                <div class="col-sm-7">
                                    <div class="dataTables_paginate" id="group_paginator" style="text-align: right">
...
<!-- 本页面管理js -->
<script type="text/javascript" src="${root}/scripts/xmoa/system/group/groupManage.js"></script>
</body>
</html>
