        ...
        <section class="content">
                        ...
                        <div class="box-tools">
                            <div class="input-group" style="width: 350px;margin: 10px 15px;">
                                <input type="text" name="table_search" class="form-control"
                                       placeholder="搜索关键字" style="z-index: 3;" id="dictDataQuery">
                                <div class="input-group-btn">
                                    <button type="button" class="btn  bg-teal" onclick="dictDataManage.queryDictData()"><i class="fa fa-search"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-sm-3">
                    ...
                    <div id="dictDataTree4dictData" class="treeview" style="height:557px ;position: relative">
                    </div>
                    ...
                    <div class="box" style="border-top: 3px solid #428BCA;margin-bottom: 0px">
                        <div class="box-header" style="padding-bottom: 0px">
                            <div class="columns columns-left btn-group pull-left tool-button-box">
                                ...
                                <button class="btn btn-default" type="button" name="sort" title="排序">
                                    <i class="fa fa-arrows-v">&nbsp;排序</i>
                                </button>
                        ...
                        <div class="box-body">
                            <div class="tab-container" style="min-height: 431px">
                                <table id="dictDataTable" class="table table-bordered table-hover table-striped">
                                    <thead>
                                    <tr>
                                        <th><input type="checkbox" id="checkAll"/></th>
                                        <th width="25%">基础代码名称</th>
                                        <th>基础代码编码</th>
                                        <th>基础代码类型</th>
                                        <th width="25%">父级基础代码</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
                            ...
                            <div class="row" style="margin-top: 10px">
                                <div class="col-sm-5">
                                    <div class="dataTables_info" id="dictData_paginator_info">

                                    </div>
                                </div>
                                <div class="col-sm-7">
                                    <div class="dataTables_paginate" id="dictData_paginator" style="text-align: right">
...
<!-- 本页面管理js -->
<script type="text/javascript" src="${root}/scripts/xmoa/system/dictData/dictDataManage.js"></script>
</body>
</html>
